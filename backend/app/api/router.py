...
from app.api.routes.admin_integrations import router as admin_integrations_router
...
from app.api.routes.admin_relay_management import router as admin_relay_management_router
...
api_router.include_router(admin_integrations_router, tags=["admin-integrations"])
...
api_router.include_router(admin_relay_management_router, tags=["admin-relay-management"])
